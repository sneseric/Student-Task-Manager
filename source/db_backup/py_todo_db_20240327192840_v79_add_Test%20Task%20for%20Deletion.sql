...
INSERT INTO `py_todo_items` VALUES (139,'manual test 3.27.24','2024-03-27'),(140,'test 2','2024-03-28'),(141,'Test Task','2023-12-31'),(143,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST; DROP DATABASE py_todo_db; --','2023-12-31'),(144,'Test Task','2023-12-31'),(145,'Test Task for Deletion','2023-12-31');
...
-- Dump completed on 2024-03-27 19:28:40
