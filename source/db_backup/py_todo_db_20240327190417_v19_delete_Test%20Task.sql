...
INSERT INTO `py_todo_items` VALUES (107,'manual test 3.27.24','2024-03-27'),(110,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31');
...
-- Dump completed on 2024-03-27 19:04:17
