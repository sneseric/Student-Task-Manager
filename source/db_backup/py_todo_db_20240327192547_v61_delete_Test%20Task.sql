...
INSERT INTO `py_todo_items` VALUES (123,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31'),(124,'Test Task','2023-12-31'),(126,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); DROP DATABASE py_todo_db; --','2023-12-31'),(127,'Test Task','2023-12-31'),(129,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST; DROP DATABASE py_todo_db; --','2023-12-31'),(130,'Test Task','2023-12-31'),(132,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); DROP DATABASE py_todo_db; --','2023-12-31'),(133,'Test Task','2023-12-31'),(135,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST; DROP DATABASE py_todo_db; --','2023-12-31'),(136,'Test Task','2023-12-31'),(138,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST; DROP DATABASE py_todo_db; --','2023-12-31');
...
-- Dump completed on 2024-03-27 19:25:47
