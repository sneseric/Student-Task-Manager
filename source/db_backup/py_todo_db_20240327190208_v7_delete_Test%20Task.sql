...
INSERT INTO `py_todo_items` VALUES (91,'manaul test 3.27.24','2024-03-27'),(92,'Test Task','2023-12-31'),(94,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; INSERT INTO py_todo_items (task_name, due_date) VALUES (\'Complete homework\', \'2024-04-05\'); DROP DATABASE py_todo_db; --','2023-12-31'),(95,'Test Task','2023-12-31'),(97,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); DROP DATABASE py_todo_db; --','2023-12-31'),(98,'Test Task','2023-12-31'),(100,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items; INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31'),(103,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31'),(104,'Test Task','2023-12-31'),(106,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31');
...
-- Dump completed on 2024-03-27 19:02:08
