...
INSERT INTO `py_todo_items` VALUES (111,'manual test 3.27.24','2024-03-27'),(112,'Test Task','2023-12-31'),(114,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0;; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31'),(115,'Test Task','2023-12-31'),(117,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0;; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31'),(118,'Test Task','2023-12-31'),(120,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0;; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31'),(121,'Test Task','2023-12-31'),(123,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); INSERT INTO py_todo_items; DROP DATABASE py_todo_db; --','2023-12-31'),(124,'Test Task','2023-12-31'),(126,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); DROP DATABASE py_todo_db; --','2023-12-31'),(127,'Test Task','2023-12-31'),(129,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST; DROP DATABASE py_todo_db; --','2023-12-31'),(130,'Test Task','2023-12-31'),(132,'\'; DROP TABLE py_todo_items; DELETE FROM py_todo_items WHERE task_id > 0; ALTER TABLE py_todo_items ADD COLUMN SQL_INJECTION_TEST VARCHAR(255); DROP DATABASE py_todo_db; --','2023-12-31'),(133,'Test Task','2023-12-31');
...
-- Dump completed on 2024-03-27 19:22:22
